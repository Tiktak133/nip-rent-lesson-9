...
class ApartmentSettlement(BaseModel):
    """An apartment settlement model representing the financial summary for an apartment in a given month and year."""
...
class TenantSettlement(BaseModel):
    """A tenant settlement model representing the financial summary for a tenant in a given month and year."""
